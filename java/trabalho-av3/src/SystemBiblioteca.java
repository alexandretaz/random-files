...
public class SystemBiblioteca
{
    ...
    public static void main (String[] args){
        ...
        do{
            ...
            if(input.isEmpty()){
                ...
                {
                    case 1:
                        SystemBiblioteca.insert(vetorLivro);
                    break;
                    case 2:
                        SystemBiblioteca.locate(vetorLivro);
                    break;
                    case 3:
                        SystemBiblioteca.update(vetorLivro);
                    break;
                    case 4:
                        SystemBiblioteca.delete(vetorLivro);
                    break;
                    case 5:
                        message="";
                            for (int k =0; k< 5; k++)
                    ...
                    default:
                        JOptionPane.showMessageDialog(null, "nenhuma entrada válida");
                }
            }
        } while(resposta != 6 );
    }
    ...
    private static Livro getLivroByCod(int cod, Livro[] vetorLivro){
       Livro livroFound;
       int pos;
        pos = SystemBiblioteca.search(cod,vetorLivro);
    ...
    private static Livro[] getLivroByTitle(String titulo, Livro[] vetorLivro ){
        Livro[] livroFound;
        livroFound = SystemBiblioteca.searchByTitle(titulo,vetorLivro);
        return livroFound;
    ...
    private static Livro[] getLivroByGender(String genero, Livro[] vetorLivro ){
        Livro[] livroFound;
        livroFound = SystemBiblioteca.searchByTitle(genero,vetorLivro);
        return livroFound;
    ...
    private static Livro[] getLivroByAuthor(String autor, Livro[] vetorLivro ){
        Livro[] livroFound;
        livroFound =  SystemBiblioteca.searchByTitle(autor,vetorLivro);
        return livroFound;
